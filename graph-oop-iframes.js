loadData(
    {
        ...
        nodes: [
            ...
            { id: 'taskManagerAfterCrash', value: { label: 'Task Manager skips recreated OOPIFs', bug: '642958', owner: 'lukasza', status: 'complete' } },
            ...
            { id: 'printAnOOPIF', value: { label: 'Print just an OOPIF', owner: 'weili', bug: '631513', status: 'complete' } },
            { id: 'pdfUtility', value: { label: 'PDF in utility process', owner: 'weili', status: 'complete' } },
